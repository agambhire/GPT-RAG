...
param environmentName string = 'rg-ccf-cmf-rag-agentic-1604'
...
param resourceGroupName string = 'rg-ccf-cmf-rag-agentic-1604'
var _resourceGroupName = !empty(resourceGroupName) ? resourceGroupName : '${environmentName}'
